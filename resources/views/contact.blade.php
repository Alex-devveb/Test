            ...
            <div class="card-body">
                <form action="{{ url('contact') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control @error('nom') isinvalid @enderror" name="nom"
                    ...
                    <div class="form-group">
                        <textarea class="form-control @error('message') isinvalid @enderror" name="message" id="message"
